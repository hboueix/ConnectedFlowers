...
SELECT 01
   ...
   , '- Arbuste de 2-5 mètres, odorant, à suc laiteux abondant 
      ...
      - fruits très petites, drupacés, renfermés dans le réceptacle accrescent et à la fin caduc.'
    ,'Juin-septembre'
    ,BulkColumn
    ,'25%'
    ,'~25°c'
...
SELECT  03
   ...
   , '- . Arbre assez élevé, à écorce crevassée-subéreuse 
    ...
    ,'~20°c'
    ,'87.5%'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\érable_champêtre.jpg', Single_Blob) as image;
...
SELECT 06
   ...
   , '- Arbre ou arbuste atteignant au plus 5-6 mètres, à écorce fendillée 
    ...
    ,'~30°c'
    ,'87.5%'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\érable_de_montpellier.jpg', Single_Blob) as image;
...
SELECT 08
   ...
   , '- Plante annuelle de 30-80 cm, hérissée de longs poils étalés et d"une pubescence glanduleuse, à racine grêle pivotante 
    ...
    ,'Pas ou manque de données'
    ,'Pas ou manque de données'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\henné_jaune.jpg', Single_Blob) as image;
...
SELECT 12
   ...
   , '- Plante vivace de 20-60 cm, glabre, gazonnante 
    ...
    ,'~10-15°c'
    ,'80-90%'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\arméria_des_sables.jpg', Single_Blob) as image;
...
SELECT 20
   ...
   , '- Plante vivace de 50 cm à 1 mètre, herbacée, pubescente-glanduleuse, dressée, à forte odeur de 	bitume 
    ...
    ,'~25°c'
    ,'62.5%'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\Psoralée.jpg', Single_Blob) as image;
...
SELECT 21
   ...
   , '- Plante bisannuelle de 40-80 cm, velue et un peu rude, à racine charnue, en fuseau 
    ...
    ,'Pas ou manque de données'
    ,'Pas ou manque de données'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\bâton_saint_jacques.jpg', Single_Blob) as image;
...
SELECT 23
   ...
   , '- Plante annuelle, glabre, un peu glauque 
    ...
    ,'~25°c'
    ,'75%'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\calépine.jpg', Single_Blob) as image;
...
SELECT 25
   ...
   , '- Plante vivace de 40-50 cm, dressée, d"un vert glauque 
    ...
    ,'Pas ou manque de données'
    ,'Pas ou manque de données'
  FROM Openrowset( Bulk 'C:\Users\arthur\Documents\SQL Server Management Studio\plante co\photo_plante\buplèvre_anguleux.jpg', Single_Blob) as image;
